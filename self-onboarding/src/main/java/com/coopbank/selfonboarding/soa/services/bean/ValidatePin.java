...
public class ValidatePin {
    public  static SOAPMessage postValidatePinRequest(SOAPMessage soapRequest, String kraEndpoint,String soaPassword) throws MalformedURLException,
    IOException {
SOAPMessage soapResponse = null;
    ...
    public static SOAPMessage getKslValidatePin(String IdNumber,String TaxPayerType,String kraEndpoint,String soaUsername,String soaPassword,String soaSystemCode) {
...
//        SOAPMessage response = null;
        ...
        try {
            ...
            String ns = "ns";
            String nsURI = "urn://co-opbank.co.ke/DataModel/BS/KRA/ValidatePinById/Get/1.0";
            ...
            SOAPElement dataInput = soapBody.addChildElement("ValidatePinInput", ns);
            
            SOAPElement operationParametersTag = dataInput.addChildElement("OperationParameters", ns);
          
            SOAPElement idNumberTag = operationParametersTag.addChildElement("IdNumber", ns);
            SOAPElement taxPayerTypeTag = operationParametersTag.addChildElement("TaxPayerType", ns);
  
            


            idNumberTag.addTextNode(IdNumber);
            taxPayerTypeTag.addTextNode(TaxPayerType);

            MimeHeaders headers = SOAPMessage.getMimeHeaders();
            headers.addHeader("SOAPAction", "\"" + "ValidatePinById" + "\"");
