...
@Slf4j
public class CustomerAccountDetailsInquiry {

	
    public  static SOAPMessage getCustomerAccDetailsInquiry(SOAPMessage soapRequest,String customerAccDetailsInquiryEndpoint,String soaPassword) throws MalformedURLException,
    IOException {
...
return soapResponse;
    ...
    public static SOAPMessage getCustomerAccountDetailsInquiry(String customerIdData,String customerAccDetailsInquiryEndpoint,String soaUsername,String soaPassword,String soaSystemCode) {
...
//        SOAPMessage response = null;
        ...
        try {
            ...
            String cus = "cus";
            String cusURI = "urn://co-opbank.co.ke/BS/Customer/CustomerAccount.Get.3.0";
            ...
            SOAPElement customerAccDetailsRqRq = soapBody.addChildElement("CustomerAccDetailsRq", cus);
            SOAPElement customerIdValue = customerAccDetailsRqRq.addChildElement("CustomerId", cus);
            SOAPElement schmCodeValue = customerAccDetailsRqRq.addChildElement("SchmCode", cus);
       

            customerIdValue.addTextNode(customerIdData);
            schmCodeValue.addTextNode("");

            MimeHeaders headers = SOAPMessage.getMimeHeaders();
            headers.addHeader("SOAPAction", "\"" + "CustAcctDtlsInq" + "\"");
            ...
            try {
                ...
                Logger.getLogger(CustomerAccountDetailsInquiry.class.getName()).log(Level.SEVERE, null, ex);
            }
//            String soapEnv = new String(out.toByteArray());
            ...
            SOAPMessageResponse = getCustomerAccDetailsInquiry((SOAPMessage),customerAccDetailsInquiryEndpoint,soaPassword);
